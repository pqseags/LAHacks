...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([segue.identifier isEqualToString:@"JobDetail"]) {
        ...
        destViewController.positionTitle = (NSString*)[Positions objectAtIndex:indexPath.row];
        destViewController.requirements = (NSString*)[Reqs objectAtIndex:indexPath.row];
        destViewController.description = (NSString*)[Infos objectAtIndex:indexPath.row];
